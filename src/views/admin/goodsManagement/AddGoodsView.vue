    ...
    data() {
        return {
            ...
            rules: {
                ...
                fineness: [
                    { required: true, message: '请输入成色', trigger: 'blur' }
                ],
                price: [
            ...
            return new Promise((resolve, reject) => {
                this.$request.get("oss/policy").then(res => {
                    ...
                    if (this.upLoadCount == 0) {
                        ...
                        _self.objData.key = res.data.dir + this.goodsForm.brand+"-"+this.goodsForm.type+"-"+this.goodsForm.info+"-"+sessionStorage.getItem('aid')+".png";
                        resolve(true);//继续图片
                        this.upLoadCount += 1
                        this.goodsForm.img="https://callay-spdb.oss-cn-hangzhou.aliyuncs.com/"+_self.objData.key
