<template>
    <div>
        ...
        <div>
            <el-button type="primary" style="" icon="el-icon-plus" @click="goToAddGoods">添加</el-button>
        </div>
        <div style="display: flex;margin-top: 15px;justify-content: center;">
            <div style="width: 100%;">
                <el-table :data="goodsVoList" style="width: 100%" border>
                    ...
                    <el-table-column label="品牌" width="300">
                        <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange(val) {
            console.log(`当前页: ${val}`);
            this.$request.get('goods/getGoodsPageByState?state=1&page=' + this.currentPage + "&rows=" + this.pageSize).then(res => {
