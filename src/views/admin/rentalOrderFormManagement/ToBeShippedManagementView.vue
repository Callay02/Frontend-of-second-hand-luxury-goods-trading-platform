 ...
 * @LastEditTime: 2024-04-20 00:22:45
                ...
                <el-table :data="tableData" style="width: 100%" :border="true">
                    ...
                    <el-table-column label="操作" fixed="right">
                        <template slot-scope="scope">
                            ...
                            <el-popconfirm title="确定取消订单吗？" @confirm="handleDelete(scope.$index, scope.row)">
...
export default {
    ...
    beforeMount() {
        ...
        this.$request
            .get(
                "rentalOrderForm/getOrderFormPageByState?state=0&page=" +
                this.currentPage +
                "&rows=" +
                this.pageSize
            )
    ...
    methods: {
        ...
        submitForm() {
            if(this.formData.logisticsNumber==null)
                ...
                this.$request.post('rentalOrderForm/delivery',this.formData).then(res=>{
                    if(res.code==200){
                        this.$message({
                            type:"success",
                            message:res.msg
        ...
        handleDelete(index, row) {
            ...
            this.$request.get('rentalOrderForm/adminCancelOrderById?id='+row.id+"&uid="+row.uid).then(res => {
                if (res.code == 200) {
                    this.$message({
                        message: res.msg,
                        type: 'success'
