            ...
            <el-container>
                <el-main>
                    ...
                    <div style="margin-top: 15px;">
                        <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 80%;"
                            @selection-change="handleSelectionChange" :stripe=true :border=true>
                            <el-table-column type="selection" width="55" :selectable="checkSelectAble">
                            </el-table-column>

                            <el-table-column label="商品" width="125">
                                <template slot-scope="scope"><el-image style="width: 100px; height: 100px"
                                        :src="scope.row.img" fit="cover">
                            ...
                            <el-table-column label="状态" width="120">
                                <template slot-scope="scope">
                                    ...
                                    <p v-else-if="scope.row.state == 0" style="color: red;">已售</p>
                                </template>
                            </el-table-column>
...
export default {
    ...
    beforeMount() {
        this.$request.get('shoppingCart/getShoppingCartById?id=' + sessionStorage.getItem('uid')).then(res => {
