...
<template>
    <div style="margin-top: 15px;">
        <el-table :data="tableData" tooltip-effect="dark" style="width: 100;" :stripe=true :border=true>
            ...
            <el-table-column prop="address" label="收货地址" width="150" sortable>
            </el-table-column>
            ...
            <el-table-column label="操作" fixed="right">
                <template slot-scope="scope">
                    <el-button size="mini" @click="toGoodsDetail(scope.row.gid)" style="margin-right: 5px;" disabled>查看</el-button>
...
export default {
    ...
    beforeMount() {
        this.$request.get('orderForm/getSignedById?id=' + sessionStorage.getItem('sid')).then(res => {
